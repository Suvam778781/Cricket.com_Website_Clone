  ...
  async function pop() {
    ...
    let res = await fetch('https://cricbuzz-cricket.p.rapidapi.com/matches/v1/recent',{
      ...
      headers: {
        'X-RapidAPI-Key':'3e964e2195msh26c1034ba9c8e20p1c15a0jsn629da52a6ea2',
        //2bd4dfd17bmshed3d003ac4dca4ap1c998ejsn2857b7d9a6ea
        //se=2197ac5954mshff90085c6c79510p1fa7e4jsnba4011af7ff4
        //3=fe386be024msh6694c0519496122p13cbc3jsn19f77a55f494
...
// news api fetch
  ...
  // data.html:151 
    let popo = async () => {
      ...
      let res = await fetch(`https://www.googleapis.com/youtube/v3/search?q=cricket.com features&key=AIzaSyCBI-yg4UA7C0YTKBt4LN_mPdsKkTTxal4&p=2&part=snippet&maxResults=10`)
////AIzaSyA6oKyep5hfcg48tu2xiwqg86FYM4_3-a4'
//my k=AIzaSyCaApnrzGZ2tPdnbzsyN-kFhmDAUwgrX34
///AIzaSyCaApnrzGZ2tPdnbzsyN
